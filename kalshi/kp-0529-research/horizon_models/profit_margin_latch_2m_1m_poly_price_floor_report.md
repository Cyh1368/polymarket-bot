...
- Bootstrap intervals use `500` contract-level resamples.
...
| floor_label | polymarket_price_floor | profit_margin | contracts | model_signal_contracts | trades | trade_rate | divergences | divergence_rate | mean_polymarket_price | mean_all_in_cost | mean_fee_adjusted_edge | mean_profit_per_trade | total_profit | bootstrap_total_profit_ci_low | bootstrap_total_profit_ci_high |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| none | 0.0000 | 0.2200 | 232 | 203 | 154 | 0.6638 | 4 | 0.0260 | 0.5286 | 0.5690 | 0.4310 | 0.4051 | 62.3802 | 54.9280 | 69.5446 |
| 25c | 0.2500 | 0.2200 | 232 | 203 | 147 | 0.6336 | 4 | 0.0272 | 0.5533 | 0.5840 | 0.4160 | 0.3887 | 57.1456 | 50.1104 | 64.1910 |
| 33c | 0.3300 | 0.2200 | 232 | 203 | 146 | 0.6293 | 4 | 0.0274 | 0.5557 | 0.5858 | 0.4142 | 0.3868 | 56.4664 | 49.6780 | 63.9354 |
| 50c | 0.5000 | 0.1600 | 232 | 203 | 117 | 0.5043 | 4 | 0.0342 | 0.6427 | 0.6708 | 0.3292 | 0.2950 | 34.5204 | 27.9244 | 41.3914 |
...
![Expected profit](plots/profit_margin_latch_2m_1m_poly_price_floor_expected_profit.png)

![Total trades](plots/profit_margin_latch_2m_1m_poly_price_floor_total_trades.png)

## Output Files

- Sweep table: `profit_margin_latch_2m_1m_poly_price_floor_sweep.csv`
- Trade table: `profit_margin_latch_2m_1m_poly_price_floor_trades.csv`
- Expected profit plot: `plots/profit_margin_latch_2m_1m_poly_price_floor_expected_profit.png`
- Total trades plot: `plots/profit_margin_latch_2m_1m_poly_price_floor_total_trades.png`
